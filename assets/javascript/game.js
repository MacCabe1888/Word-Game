...
let game = {
    ...
    //the player's letter guesses, the array which will be displayed as a series of blanks being filled in with the player's correct guesses, and the previous round's correct answer all start out empty or undefined
    yourGuesses: "",
    answerArray: [],
    lastAnswer: [],
